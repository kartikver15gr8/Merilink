  ...
  return (
    <div className="flex flex-col p-10 justify-center items-center ">
      ...
      <div className="flex flex-wrap justify-center mt-20">
        <div className="w-full my-2 md:w-[350px] flex-col bg-slate-100 border-slate-200 border mx-4 rounded-2xl shadow-xl hover:scale-105 transition-all duration-300 items-center flex mb-8 md:mb-0">
          <div className="w-64 md:w-72 rounded-full flex items-center justify-center text-base md:text-xl mt-8 md:mt-20 bg-black text-white font-bold py-4 px-6 hover:scale-105 transition-all duration-300">
            <p>meril.ink/me</p>
          </div>
          <div className="w-64 md:w-72 flex-col rounded-full flex items-center justify-center text-sm md:text-lg mt-8 md:mt-20 py-4 px-6">
            <p className="text-center">Share your in link bio seamlessly</p>
            <p className="text-center">in just a few clicks</p>
          </div>
        </div>
        <div className="w-full md:w-[350px] my-2 flex-col bg-slate-100 border-slate-200 border mx-4 rounded-2xl shadow-xl hover:scale-105 transition-all duration-300 items-center pt-8 md:pt-16 flex mb-8 md:mb-0">
          <div className="w-56 md:w-64 rounded-full flex items-center text-base md:text-xl my-2 bg-sky-300 py-3 px-4 hover:scale-105 transition-all duration-300">
            <svg
            ...
            <div className="w-12 md:w-20 h-[14px] rounded-full bg-blue-400"></div>
          </div>
          ...
          <div className="w-full flex-col rounded-full flex items-center justify-center text-sm md:text-md mt-5 h-20">
            <p className="text-center">
              Customize your Meril.ink to match your
            </p>
            <p className="text-center">brand. Make it feel like you</p>
          </div>
        </div>
        <div className="w-full md:w-[350px] my-2 flex-col bg-slate-100 border-slate-200 border mx-4 rounded-2xl shadow-xl hover:scale-105 transition-all duration-300 items-center pt-8 md:pt-16 flex mb-8 md:mb-0">
          <div className="flex mb-8 md:mb-20">
            ...
            <div className="bg-violet-300 w-16 md:w-20 h-16 md:h-20 rounded-full mx-1 flex justify-center items-center text-white font-bold hover:scale-105 transition-all duration-300">
              <p className="text-sm md:text-base">Jun</p>
            </div>
            <div className="bg-blue-500 w-16 md:w-20 h-16 md:h-20 rounded-lg md:rounded-xl mx-1 flex justify-center items-center text-white font-bold hover:scale-105 transition-all duration-300">
              <p className="text-sm md:text-base">2:44am</p>
            </div>
          </div>
          <div className="w-full flex-col rounded-full flex items-center justify-center text-sm md:text-md mt-5 md:mt-10 h-20">
            <p className="text-center">
              Customize your Meril.ink to match your
            </p>
            <p className="text-center">brand. Make it feel like you</p>

...
export default function Footer() {
  return (
    ...
    <div className="flex flex-col w-full justify-center items-center">
      ...
      <div className="flex flex-wrap justify-center mb-5 md:mb-10">
        <p className="mx-2 md:mx-3 text-black hover:text-slate-400 mb-2 md:mb-0">
          Log in
        </p>
        <p className="mx-2 md:mx-3 text-black hover:text-slate-400 mb-2 md:mb-0">
          About
      ...
      <div className="h-20 flex justify-center items-center px-4">
        <p className="text-center">
          © 2024 Meril.ink pvt ltd | All Rights Reserved
        </p>
      </div>
    </div>
  );

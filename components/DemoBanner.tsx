...
export default function DemoBanner() {
    return (
        <div className="w-full  justify-center flex my-2 sm:my-2 px-1 md:my-10 lg:my-10 xl:my-10 2xl:my-10">
            <div className="flex p-4 justify-center items-center bg-purple-500  h-[250px] w-[450px] rounded-xl shadow-xl sm:w-[500px] sm:h-[330px] md:w-[600px] md:h-[380px] lg:w-[900px] lg:h-[550px]  xl:w-[1150px] xl:h-[600px] 2xl:w-[1200px] 2xl:h-[650px]">
                <Image

...
export default function Handle({ params }: any) {
  ...
  return (
    <>
      <div
        className={`h-screen grid grid-cols-1 lg:grid-cols-2 p-5 justify-center  ${bg}`}
      >
        ...
        <div className=" grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-x-4 gap-y-4  p-4">
          {userName == user?.name && (
            <Link
              href="/addlinks"
          ...
          {userLinks?.twitter && (
            <SocialCard
              ...
              className=" bg-slate-200 border-slate-200 border-[1px] rounded-xl p-3"
          ...
          {userLinks?.github && (
            <SocialCard
              ...
              className=" bg-slate-400 border-slate-200 border-[1px] rounded-xl p-3"
          ...
          {userLinks?.linkedin && (
            <SocialCard
              ...
              className=" bg-blue-200 border-slate-200 border-[1px] rounded-xl p-3"
          ...
          {userLinks?.instagram && (
            <SocialCard
              ...
              className=" bg-pink-300 border-slate-200 border-[1px] rounded-xl p-3"
          ...
          {userLinks?.twitch && (
            <SocialCard
              ...
              className=" bg-violet-200 border-slate-200 border-[1px] rounded-xl p-3"
          ...
          {userLinks?.medium && (
            <SocialCard
              ...
              className=" bg-slate-300 border-slate-200 border-[1px] rounded-xl p-3"
          ...
          {userLinks?.gumroad && (
            <SocialCard
              ...
              className=" bg-pink-200 border-slate-200 border-[1px] rounded-xl p-3"
          ...
          {userLinks?.hashnode && (
            <SocialCard
              ...
              className=" bg-slate-100 border-slate-200 border-[1px] rounded-xl p-3"
          ...
          {userLinks?.youtube && (
            <SocialCard
              ...
              className=" bg-red-200 border-slate-200 border-[1px] rounded-xl p-3"
          ...
          {userLinks?.producthunt && (
            <SocialCard
              ...
              className=" bg-orange-300 border-slate-200 border-[1px] rounded-xl p-3"
          ...
          {userLinks?.substack && (
            <SocialCard
              ...
              className=" bg-orange-200 border-slate-200 border-[1px] rounded-xl p-3"
      ...
      {/* <div className="absolute flex justify-center h-14 w-full bottom-5">
        <div className="h-14 flex border border-[#bdbdc2] w-fit p-1 rounded-lg bg-[#f4f4f5]">
          <div
            onClick={() => {
              setBg(
